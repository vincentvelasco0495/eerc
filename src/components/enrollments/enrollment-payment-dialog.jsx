      ...
      <DialogContent sx={{ typography: 'body2' }}>
        <Stack spacing={2.5}>
          <Typography variant="body2" color="text.secondary">
            Complete payment for <strong>{programTitle}</strong>, then upload your receipt. An
            administrator will verify your proof before approving enrollment.
          </Typography>
          ...
          <Stack spacing={1.25}>
            ...
            {ENROLLMENT_PAYMENT_CONFIG.methods.map((method) => (
              <PaymentMethodBlock key={method.title} method={method} />
            ))}
          </Stack>
