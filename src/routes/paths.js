...
export const paths = {
  ...
  dashboard: {
    ...
    instructorProfile: `${ROOTS.DASHBOARD}/instructor-profile`,
    instructorSettings: `${ROOTS.DASHBOARD}/instructor-settings`,
    instructorGradebook: `${ROOTS.DASHBOARD}/instructor-gradebook`,
    instructorAnnouncement: `${ROOTS.DASHBOARD}/instructor-announcement`,
    instructorCourseCurriculum: `${ROOTS.DASHBOARD}/instructor-course-curriculum`,
    instructorAssignments: `${ROOTS.DASHBOARD}/instructor-assignments`,
    studentAssignments: `${ROOTS.DASHBOARD}/assignments`,
    studentProfile: `${ROOTS.DASHBOARD}/student-profile`,
    studentSettings: `${ROOTS.DASHBOARD}/settings`,
