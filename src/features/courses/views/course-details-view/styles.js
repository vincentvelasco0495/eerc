...
export const styles = {
  ...
  /** Chips on `courseArtSx` thumbnails — theme `warning` / `error` chips can be illegible on dark gradients. */
  thumbOverlayChip: {
    position: 'absolute',
    zIndex: 1,
    maxWidth: 'min(calc(100% - 16px), 200px)',
    height: 26,
    fontWeight: 700,
    color: '#ffffff',
    bgcolor: 'rgba(15, 23, 42, 0.92) !important',
  ...
  thumbOverlayChipPopular: { top: 6, left: 6 },
  thumbOverlayChipRelated: { top: 10, left: 10 },
  thumbOverlayChipRelatedRight: { top: 10, right: 10, left: 'auto' },
  popularCourseLink: {
    gap: 1.5,
    width: 1,
    color: 'inherit',
