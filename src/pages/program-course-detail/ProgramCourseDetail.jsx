...
/** Sidebar completion card header + CONTINUE + secondary actions */
...
/**
 * Fork of the styled-components learner course detail shell for **Programs** nav.
 * Routed at **`/program-course-detail`** — safe to diverge from `/course-detail`.
 */
              ...
              <ActionsRow role="toolbar" aria-label="Secondary actions">
                <QuietBtn type="button">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden stroke="currentColor" strokeWidth="1.75">
                    <path d="M12 21C12 21 5 14.36 5 9.5A4.5 4.5 0 0112 8a4.5 4.5 0 017 1.5C19 14.36 12 21 12 21z" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  Add to wishlist
                </QuietBtn>
                <QuietBtn type="button">
