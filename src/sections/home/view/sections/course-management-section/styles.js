...
export const styles = {
  ...
  addons: {
    ...
    cardStack: { height: 1, textAlign: 'center' },
    previewWrap: { p: { xs: 2, md: 2.5 }, borderRadius: 2.5, bgcolor: (theme) => subtleBackground(theme), border: '1px solid rgba(123, 140, 182, 0.14)', boxShadow: '0 18px 40px rgba(15, 23, 42, 0.05)' },
