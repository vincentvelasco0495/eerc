...
class RolePagePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['role' => 'admin', 'path' => '/gradebook', 'match_type' => 'exact', 'query' => null, 'label' => 'Gradebook', 'sort_order' => 42],
            ['role' => 'admin', 'path' => '/assignment', 'match_type' => 'exact', 'query' => null, 'label' => 'Assignments', 'sort_order' => 43],
            ...
            ['role' => 'instructor', 'path' => '/gradebook', 'match_type' => 'exact', 'query' => null, 'label' => 'Gradebook', 'sort_order' => 42],
            ['role' => 'instructor', 'path' => '/assignment', 'match_type' => 'exact', 'query' => null, 'label' => 'Assignments', 'sort_order' => 43],
            ['role' => 'instructor', 'path' => '/courses', 'match_type' => 'prefix', 'query' => null, 'label' => 'Courses', 'sort_order' => 44],
            ['role' => 'instructor', 'path' => '/quizzes/history', 'match_type' => 'prefix', 'query' => null, 'label' => 'Quiz attempt history', 'sort_order' => 45],
            ['role' => 'instructor', 'path' => '/quizzes', 'match_type' => 'prefix', 'query' => null, 'label' => 'Quizzes', 'sort_order' => 46],
